...
//选择文件按钮
public class BigFileButtonDerby extends JButton{
			...
			public void actionPerformed(ActionEvent e) {
                ...
                if(result == JFileChooser.APPROVE_OPTION)
                {
                    ...
                    if (file!=null){
                        ...
                        MainFrame.bigEventCollectionDerby = new BigEventCollectionDerby();
                        MainFrame.bigCaseCollectionDerby = new BigCaseCollectionDerby();
                        MainFrame.bigVariantCollectionDerby = new BigVariantCollectionDerby();
						MainFrame.bigAnimationDerby = new BigAnimationDerby();
						
                        MainFrame.mainFrame.getContentPane().removeAll();
    					System.gc();
    					BigImportPanelDerby importPanel = new BigImportPanelDerby(file.getAbsolutePath(), separatorText.getText(), tableHead.isSelected(), encoding.getItemAt(encoding.getSelectedIndex()));
